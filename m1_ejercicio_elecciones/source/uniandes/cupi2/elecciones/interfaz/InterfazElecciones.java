...
public class InterfazElecciones extends JFrame
{
	...
	public void reqFuncOpcion1( ){
    	try { 
    		Object[] possibilities1 = { "Candidato 1", "Candidato 2", "Candidato 3" };
    		String Candidato =( String )JOptionPane.showInputDialog( this, "Elija un Candidato",null, JOptionPane.QUESTION_MESSAGE, null, possibilities1, "Candidato 1"); 
	        String Nombres = JOptionPane.showInputDialog( this, "Ingrese el nombre");
			String Apellidos = JOptionPane.showInputDialog( this, "Ingrese el apellido:");
			String Partido = JOptionPane.showInputDialog( this, "Ingrese el partido");
			int Edad = Integer.parseInt(JOptionPane.showInputDialog( this, "Ingrese la edad"));
			if(Candidato !=null && Nombres != null && Apellidos != null && Partido != null && Edad >=18){
				urna.metodo1(Candidato,Nombres,Apellidos,Partido,Edad);
			}else {
