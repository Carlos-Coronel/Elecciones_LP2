...
public class Urna
{
    ...
    public double calcularPorcentajeVotosPorInternetCandidato1( )
    {
        ...
        double votosTotales;
        double porcentaje;
        numVotosCandidato1 = candidato1.darVotosInfluenciaInternet();
        votosTotales = calcularTotalVotosInternet();
        porcentaje = numVotosCandidato1 / votosTotales * 100;
        return porcentaje;
    }
    ...
    public double calcularPorcentajeVotosPorInternetCandidato2( )
    {
        ...
        double votosTotales;
        double porcentaje;
        numVotosCandidato2 = candidato2.darVotosInfluenciaInternet();
        votosTotales = calcularTotalVotosInternet();
        porcentaje = numVotosCandidato2 / votosTotales * 100;
        return porcentaje;
    }
    ...
    public double calcularPorcentajeVotosPorInternetCandidato3( )
    {
        ...
        double votosTotales;
        double porcentaje;
        numVotosCandidato3 = candidato3.darVotosInfluenciaInternet( );
        votosTotales = calcularTotalVotosInternet( );
        porcentaje = numVotosCandidato3 / votosTotales * 100;
        return porcentaje;
    }
    ...
    public void metodo1(String candidato,String nombre,String apellido,String partido, int edad){
    	if(candidato.equals("Candidato 1")){
    		candidato1.cambiarDatosCandidato(nombre, apellido, partido, edad);
        }else {
       	 if(candidato.equals("Candidato 2")){
       		candidato2.cambiarDatosCandidato(nombre, apellido, partido, edad);
            }else {
           	 if(candidato.equals("Candidato 3")){
           		candidato3.cambiarDatosCandidato(nombre, apellido, partido, edad);
                }
            }
        }
    }
    ...
    public void metodo2() {
    	int c1 = candidato1.darVotos();
    	int c2 = candidato2.darVotos();
    	int c3 = candidato3.darVotos();
    	candidato1.VotosCandidato(c1, c2, c3);
    }
}