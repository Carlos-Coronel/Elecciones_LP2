...
public class Candidato
{
     ...
     */
     ...
     //Numero de Votos Candidatos
     private int votosCand1;
     private int votosCand2;
     private int votosCand3;
     //Lista de datos de los votos
     private ArrayList<String[]> votosCandiato = new ArrayList<String[]>();
    // -----------------------------------------------------------------
    // Métodos
    // -----------------------------------------------------------------
    ...
    public void VotosCandidato(int candidato1,int candidato2, int candidato3) {
    	votosCand1= candidato1;
    	votosCand2= candidato2;
    	votosCand3= candidato3;
    	escribe();
    }
  
    public void cambiarDatosCandidato(String cNombre,String cApellido,String cPartido, int cEdad ){
        nombre = cNombre;
        apellido = cApellido;
        partidoPolitico = cPartido;
        edad = cEdad;
    }
    public String[] getArray(){
        String[] data = new String[]{String.valueOf(votosCand1),String.valueOf(votosCand2),String.valueOf(votosCand3)};
        return data;
    } 
    public void escribe() {
        try{
            String csv = "Votos.csv";
            CSVWriter writer = new CSVWriter(new FileWriter(csv),';');
            String[] header= new String[]{"Candidato 1","Candidato 2","Candidato 3"};
            writer.writeNext(header);
            String[] registroVotos = getArray();
            votosCandiato.add(registroVotos);
            writer.writeAll(votosCandiato);
            writer.close();
            JOptionPane.showMessageDialog(null, "Votos guardados");
        }catch(IOException e) {
